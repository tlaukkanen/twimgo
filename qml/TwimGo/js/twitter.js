...
var Twitter = function() {
    ...
    var PUBLIC_TIMELINE_URL = "https://api.twitter.com/1.1/statuses/public_timeline.json";
    var MENTIONS_TIMELINE_URL = "https://api.twitter.com/1.1/statuses/mentions_timeline.json";
    var DIRECT_TIMELINE_URL = "https://api.twitter.com/1.1/direct_messages.json";
    var FAVOURITES_TIMELINE_URL = "https://api.twitter.com/1.1/favorites/list.json";
    var RETWEETSME_TIMELINE_URL = "https://api.twitter.com/1.1/statuses/retweets_of_me.json";
    var TWEET_TIMELINE_URL = "https://api.twitter.com/1.1/statuses/show/@id.json";

    // Friends and Followers
    var FRIENDS_IDS_URL = "https://api.twitter.com/1.1/friends/ids.json";

    // Lists
    var LISTS_URL = "https://api.twitter.com/1.1/lists/list.json";

    // Trends (Worldwide)
    var TRENDS_URL = "https://api.twitter.com/1.1/trends/place.json?id=1";

    // Users
    var USER_URL = "https://api.twitter.com/1.1/users/lookup.json";

    // Actions
    var STATUS_UPDATE_URL = "https://api.twitter.com/1.1/statuses/update.json";
    var RETWEET_URL = "https://api.twitter.com/1.1/statuses/retweet/";
    var FAVOURITE_URL = "https://api.twitter.com/1.1/favorites/create.json";
    var UNFAVOURITE_URL = "https://api.twitter.com/1.1/favorites/destroy.json";
    var FOLLOW_URL = "https://api.twitter.com/1.1/friendships/create.json";
    var UNFOLLOW_URL = "https://api.twitter.com/1.1/friendships/destroy.json";
    var DIRECT_URL = "https://api.twitter.com/1.1/direct_messages/new.json";
    var SEARCH_URL = "https://api.twitter.com/1.1/search/messages.json";
    var DESTROY_URL = "https://api.twitter.com/1.1/statuses/destroy/@id.json";

    // Searches
    var SEARCHES_URL = "https://api.twitter.com/1.1/saved_searches.json";
    var SAVE_SEARCH_URL = "https://api.twitter.com/1.1/saved_searches/create.json";
    var REMOVE_SEARCH_URL = "https://api.twitter.com/1.1/saved_searches/destroy/@id.json";

    // API
    var RATE_LIMIT_STATUS_URL = "https://api.twitter.com/1.1/application/rate_limit_status.json";

    // Time
    var TIME_TEST_URL = "https://api.twitter.com/1.1/help/test.json";

    // Sorry... These aren't public
    var CONSUMER_KEY = "secret+code";
    var CONSUMER_SECRET = "secret+code";
    ...
    this.loadFriends = function(callback) {
        xauth.webRequest(false, FRIENDS_IDS_URL, "", callback);
    }

    /** Login to Twitter */
    this.login = function(verifier) {
        if(hasToken) {
        ...
        console.log( "Loading tokens from DB with verifier " + verifier );
         ...
         if(tokenDBCounter==2) {
             if(token.indexOf("-")>0) {
                ...
                console.log("Getting access token");
                 xauth.setOAuthVerifier(tokenVerifier);
    ...
    this.getLists = function(user, callback) {
        xauth.webRequest(false, LISTS_URL, "", callback);
    }
...
/*        var doc = new XMLHttpRequest();
    ...
    this.favourite = function(tweetid, callback) {
        var params = new Array();
        params.push(["id", tweetid]);
        xauth.webRequest(true, FAVOURITE_URL, params, callback);
    }
    ...
    this.unfavourite = function(tweetid, callback) {
        var params = new Array();
        params.push(["id", tweetid]);
        xauth.webRequest(true, UNFAVOURITE_URL, params, callback);
    }
