...
var PUBLIC_TIMELINE = "https://api.twitter.com/1.1/statuses/public_timeline.json";
var RETWEETSTOME_TIMELINE_URL = "https://api.twitter.com/1.1/statuses/retweeted_to_me.json";
var FRIENDS_TIMELINE_URL = "https://api.twitter.com/1.1/statuses/home_timeline.json";
var FRIENDS_URL = "https://api.twitter.com/1.1/friends/list.json";
var FOLLOWERS_TIMELINE_URL = "https://api.twitter.com/1.1/followers/list.json";
...
var LIST_STATUSES_URL = "https://api.twitter.com/1.1/:user/lists/:id/statuses.json";
...
function getTwitterTimeAndLogin() {
    ...
    // Since 1.1 API doesn't support help/test.json we can skip this
...
function parseRateLimit(data) {
    ...
    resetDate.setTime(rate.resources.statuses["/statuses/home_timeline"].reset);
    ...
    mainMenu.apiStatus = "API remaining hits: " + rate.resources.statuses["/statuses/home_timeline"].remaining + " reset at " + hours + ":" + minutes;
}
...
function loadFollowers() {
    loadTimeline(FOLLOWERS_TIMELINE_URL + "?user_id=" + currentUserID, false);
}
...
function loadFriends() {
    loadTimeline(FRIENDS_URL + "?user_id=" + currentUserID, false);
}
...
function parseSearchResults(searchResults) {
    var data = "";
    try {
        data = eval("[" + searchResults + "]");
        append = false;
        autoRefresh = false;
        doTweets(data[0].statuses);
